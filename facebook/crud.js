...
module.exports = function(model, images, oauth2, logging) {
  ...
  router.get('/friends/:id', function list(req, res) {
    res.render('facebook/friends.jade', {
      id: req.params.id,
      friend: {}
    });
  });
